...
def get_onedrive_path(
    ...
    """
    folder_options = [
        'onedrive', "ftg",'entrainment', 'data', 'results', 'figures', 'externalized_entrainment'
    ]
    ...
    elif folder.lower() == 'externalized_entrainment': return os.path.join(path, 'EXTERNALIZED_ENTRAINMENT')
